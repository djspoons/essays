...
<!-- Better to use indexed time like t_n instead of n? -->
...
$$
(This is a reasonable thing to do since digital-analog converters will do some smoothing and since a physical speaker membrane can't instantaneously jump from one position to the next.) We can substitute the definition of $\phi_\text{approx}[t_n]$ to get:
$$
