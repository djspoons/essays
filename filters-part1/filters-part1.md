...
<div class="container">
  <tuun-synth description="Pure tone + clicks"
    expression="$220 + reset($1, fixed([1,1,1]))">
  </tuun-synth>
  <tuun-synth description="Pure tone + clicks with moving average filter"
    expression="$220 + reset($1, fixed([1,1,1])) | moving_average(15)">
  </tuun-synth>
</div>
...
Moving average filters have some surprising (to me) behavior. This waveform uses the same filter and starts with the same two tones, but instead of staying constant, the frequency of the second tone is gradually increased over time (that is, it is a "frequency sweep").
...
<div style="display: flex; justify-content: space-around;">
  <img src="similar-case1.png" alt="High similarity" width="25%" />
  <img src="similar-case2.png" alt="Zero similarity" width="25%" />
  <img src="similar-case3.png" alt="Low similarity" width="25%" />
</div>
...
<div style="text-align: center;">
  <img src="moving-average-frequency-response.png"
    alt="Moving average frequency response">
</div>

<!--
Here's the impulse response with some zeros on both sides:
  (0 | seq(time - 2)) + (fixed(unfold(fn(x) => 1, 1, 16)) | seq(time - 2)) + 0 | capture("imp")
-->
